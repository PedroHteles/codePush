...
config.development = {
  ...
  db: {
    username: process.env.RDS_USERNAME || "sqluser",
  ...
  local: {
    ...
    storageDir: process.env.STORAGE_DIR || "D:/develop/codePush/storage",
    // Binary files download host address which Code Push Server listen to. the files storage in storageDir.
    downloadUrl: process.env.LOCAL_DOWNLOAD_URL || "http://127.0.0.1:3000/download",
    // public static download spacename.
    public: 'D:/develop/codePush/download'
  },
  jwt: {
    // Recommended: 63 random alpha-numeric characters
    // Generate using: https://www.grc.com/passwords.htm
    tokenSecret: process.env.TOKEN_SECRET || "QX(2tk'up8[rt>2~i<ZH2ct_Lh>C2f`79(4!~-{4Q$5BBx&Sq6nQ&v[8UO,tO"
  },
  common: {
    /*
